...
rod_sim.dampen(rod).using(AnalyticalLinearDamper, uniform_damping_constant=0.1, time_step=1e-4)

F_small = 1.0e-3
start_force = np.array([0, 0, 0])
end_force = np.array([0, -F_small, 0])
rod_sim.add_forcing_to(rod).using(EndpointForces, start_force=start_force, end_force=end_force, ramp_up_time=1.0)
